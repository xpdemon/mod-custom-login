...
public:
    ...
    void OnFirstLogin(Player *player) {
        ...
        if (LoginEnable) {
            ...
            if (LoginBOA) {
                // Define Equipment
                uint32 shoulders = 0, chest = 0, trinket = 0, weapon = 0, weapon2 = 0, weapon3 = 0, shoulders2 = 0,
                        chest2 = 0, trinket2 = 0;
                ...
                switch (player->GetSession()->GetSessionDbcLocale()) {
                    case LOCALE_frFR: {
                        ...
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Vous avez |cFFBDB76Bune surprise|cffFF8000 dans vos sac!";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    }
                    default: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] The Owner has placed |cFFBDB76Ba surprise|cffFF8000 in your backpack!";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    };
                }
            ...
            if (LoginSkills) {
                ...
                switch (player->GetSession()->GetSessionDbcLocale()) {
                    case LOCALE_frFR: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Vous avez |cFFBDB76Bde nouvelles compétences|cffFF8000.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    }
                    default: {
                        std::ostringstream ss;
                        ss << "|cffFF8000[|cFFBDB76BCL|cffFF8000] You have |cFFBDB76Bnew skills|cffFF8000.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    };
                }
            }
            ...
            if (LoginSpecialAbility) {
                ...
                switch (player->GetSession()->GetSessionDbcLocale()) {
                    case LOCALE_frFR: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Votre grimoire a été |cFFBDB76Binscrit avec des compétences spéciales|cffFF8000.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    }
                    default: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Your spellbook has been scribed with |cFFBDB76Bspecial abilities|cffFF8000.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    };
                }
            }
            ...
            if (LoginReputation) {
                ...
                switch (player->GetSession()->GetSessionDbcLocale()) {
                    case LOCALE_frFR: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Vous êtes maintenant |cFFBDB76BExalté|cffFF8000 avec les capitales de votre faction.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    }
                    default: {
                        std::ostringstream ss;
                        ss <<
                                "|cffFF8000[|cFFBDB76BCL|cffFF8000] Your are now |cFFBDB76BExalted|cffFF8000 with your faction's capital cities.";
                        ChatHandler(player->GetSession()).SendSysMessage(ss.str().c_str());
                    };
                }
            }
            ...
            if (LoginPlayerAnnounce) {
                ...
                if (player->GetTeamId() == TEAM_ALLIANCE) {
                    switch (player->GetSession()->GetSessionDbcLocale()) {
                        case LOCALE_frFR: {
                            std::ostringstream ss;
                            ss << "|cffFFFFFF[|cff2897FF Alliance |cffFFFFFF]:|cff4CFF00 " << player->GetName() <<
                                    "|cffFFFFFF est en ligne.";
                            sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                        }
                        default: {
                            std::ostringstream ss;
                            ss << "|cffFFFFFF[|cff2897FF Alliance |cffFFFFFF]:|cff4CFF00 " << player->GetName() <<
                                    "|cffFFFFFF has come online.";
                            sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                        }
                    }
                } else {
                    switch (player->GetSession()->GetSessionDbcLocale()) {
                        case LOCALE_frFR: {
                            std::ostringstream ss;
                            ss << "|cffFFFFFF[|cffFF0000 Horde |cffFFFFFF]:|cff4CFF00 " << player->GetName() <<
                                    "|cffFFFFFF est en ligne.";
                            sWorld->SendServerMessage(SERVER_MSG_STRING, ss.str().c_str());
                        }
                        default: {
